...
HD_PWD='C:/Users/Dhruv/Desktop/DSD II/Lab_3/Instruction_Fetch/Lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InstructionFetch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InstructionFetch.tcl -notrace
