...
constant test_vector_array : test_array := (
	...
	(rst => '0', Instruction => x"02b58b46"),
	(rst => '0', Instruction => x"245fff5e"),
	(rst => '0', Instruction => x"15561234"),
	(rst => '0', Instruction => x"0ed7ba98"),
	(rst => '0', Instruction => x"1234bed9")
);
...
--TODO:	assert statement
		assert instruction = test_vector_array(i).Instruction report "wrong instruction given" severity error;
