...
HD_PWD='C:/Users/Dhruv/Desktop/DSD II/Lab_5/Memory_Stage/Memory_Stage/Memory_Stage.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Memory_Stage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Memory_Stage.tcl -notrace
