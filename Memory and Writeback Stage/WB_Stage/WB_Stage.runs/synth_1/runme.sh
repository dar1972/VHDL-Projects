...
HD_PWD='C:/Users/Dhruv/Desktop/DSD II/Lab_5/WB_Stage/WB_Stage.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WB_Stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WB_Stage.tcl
